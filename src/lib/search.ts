...
const pages: SearchItem[] = [
  ...
  ["All therapies", "Full formulary, filterable", "/therapies", "drugs medications formulary browse"],
  ["Conditions we treat", "By specialty", "/conditions", "diagnosis disease illness"],
  ["Wellness & regenerative", "Drip menu and injections", "/wellness", "vitamin hydration iv bar myers nad"],
  ["What to expect", "Your first visit, start to finish", "/patients", "first visit new patient prepare bring"],
  ["Patient FAQ", "Answers to common questions", "/patients/faq", "questions help answers"],
  ["Insurance & billing", "Coverage, prior auth, assistance", "/insurance", "cost price copay coverage cherry hsa medicare payment"],
  ["For providers", "Referral requirements", "/providers", "refer referral physician doctor fax order"],
  ["The suite", "Inside the infusion center", "/suite", "photos chairs recliner amenities wifi parking"],
  ["Visit us", "Map, directions and hours", "/locations", "address directions map hours parking midlothian"],
  ["About IV League", "The practice", "/about", "story team who we are"],
  ["Contact", "New patient inquiry", "/contact", "call email phone inquiry get started book"],
  ["Notice of Privacy Practices", "HIPAA", "/legal/hipaa", "hipaa privacy phi rights"],
